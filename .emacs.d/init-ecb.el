...
;;to keep a persistent compile window 
...
p  "hide ecb and then split emacs into 2 windows that contain 2 most recent buffers"
  (interactive)
...
(global-set-key (kbd "C-x C-e") 'tmtxt/ecb-deactivate)
