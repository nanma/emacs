(add-to-list 'load-path "~/.emacs.d/site-lisp/org-8.2.1/lisp")
(add-to-list 'load-path "~/.emacs.d/site-lisp/org-8.2.1/contrib/lisp")
...
\\setmainfont{Liberation Sans}%英文字体
\\newcommand\\fontnamemono{DejaVu Sans Mono}%等宽字体
\\newfontinstance\\MONO{\\fontnamemono}
\\newcommand{\\mono}[1]{{\\MONO #1}}
\\setCJKmainfont[Scale=0.9]{NSimSun}%中文字体
